...
product4 = Product.new(title: "surf quicksilver 100", category: "surf", price_per_day: 27, location: "Les Arcs", description: "The best pair of skis ever!!!!!!!!!!!!!!!!")
product4.user = xavier
product4.save

product5 = Product.new(title: "surf Rossignol enfant", category: "surf", price_per_day: 40, location: "Valmorel", description: "The best pair of skis ever!!!!!!!!!!!!!!!!")
product5.user = xavier
product5.save

product6 = Product.new(title: "surf Head 130", category: "surf", price_per_day: 10, location: "Argentiere", description: "The best pair of skis ever!!!!!!!!!!!!!!!!")
